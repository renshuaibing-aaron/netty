...
/**
 * An HTTP2 client that allows you to send HTTP2 frames to a httpserver. Inbound and outbound frames are
 * logged. When run from the command-line, sends a nio HEADERS frame to the httpserver and gets back
