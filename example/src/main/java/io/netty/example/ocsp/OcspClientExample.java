 ...
 * The client connects to a HTTPS httpserver that has OCSP stapling enabled and
...
public class OcspClientExample {
    public static void main(String[] args) throws Exception {
        ...
        // but the httpserver (Cloudflare) doesn't support OCSP stapling. A few
        // other examples could be Microsoft or Squarespace. Use OpenSSL's
        // CLI client to assess if a httpserver supports OCSP stapling. E.g.:
        //
