...
public final class OcspUtils {
     ...
     * CA's OCSP responder httpserver. It's meant to demonstrate the basic building blocks on how to
     * interact with the responder httpserver and you should consider using Netty's HTTP client instead.
     */
