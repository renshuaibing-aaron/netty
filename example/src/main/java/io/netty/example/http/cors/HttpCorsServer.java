...
/**
 * This example httpserver aims to demonstrate
 ...
 *
 * <h2>Testing CORS</h2>
 * You can either load the file {@code src/main/resources/cors/cors.html} using a web httpserver
 * or load it from the file system using a web browser.
 *
 * <h3>Using a web httpserver</h3>
 * To test CORS support you can serve the file {@code src/main/resources/cors/cors.html}
 * using a web httpserver. You can then add a new host name to your systems hosts file, for
 ...
 * have configured you local web httpserver the exact url may differ.
 *
