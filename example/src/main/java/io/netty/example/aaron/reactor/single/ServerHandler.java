...
public class ServerHandler  implements Handler  {
    ...
    ServerHandler(SocketChannel socketChannel, Selector selector) throws IOException {
    ...
    @Override
    public void handle() {
        System.out.println("=========ServerHandler==========="+Thread.currentThread());
        try {
            switch (status) {
                case READ:
                    read();
