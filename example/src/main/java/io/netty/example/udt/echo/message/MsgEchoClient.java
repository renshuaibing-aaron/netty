 ...
 * to the httpserver. Simply put, the echo client initiates the ping-pong traffic
 * between the echo client and httpserver by sending the first message to the
 * httpserver.
 */
