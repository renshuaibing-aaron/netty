...
public abstract class AbstractNioMessageChannel extends AbstractNioChannel {
    ...
    private final class NioMessageUnsafe extends AbstractNioUnsafe {
        ...
        public void read() {
            ...
            //这里的读是读取一个连接
            //首先判断是nio 内部线程进行(检查该 eventloop 线程是否是当前线程) ,主要是线程安全考虑
            ...
            try {
                ...
                for (int i = 0; i < size; i ++) {
                    ...
                    //  处理新的连接的逻辑来到这, 意思是让pipeline中发生事件传播,
                    //  pipeline是谁的呢?  现在是NioMessageUnsafe  所以是服务端的,
                    //  事件是如何传播的呢?  head-->>ServerBootstrapAcceptor-->>tail 依次传播,
                    //  传播的什么事件?  ChannelRead,  也就是说,会去调用 ServerBootstrapAcceptor的ChannelRead方法,跟进去
