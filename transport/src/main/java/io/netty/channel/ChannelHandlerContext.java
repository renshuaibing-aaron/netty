 ...
 * one {@link ChannelPipeline}.  It means a nio {@link ChannelHandler}
 * instance can have more than one {@link ChannelHandlerContext} and therefore
 * the nio instance can be invoked with different
...
public interface ChannelHandlerContext extends AttributeMap, ChannelInboundInvoker, ChannelOutboundInvoker {
    ...
    /**
     * 触发读事件 fireChannelRead  本质是找到一个channelHandlerContest 继续传播
     * @param msg
     * @return
     */
    @Override
