...
public class DnsNameResolverTest {
    ...
    /**
     * This test will start an second DNS test httpserver which returns fixed results that can be easily verified as
     * originating from the second DNS test httpserver. The resolver will put {@link DnsServerAddressStreamProvider} under
    ...
    private static void secondDnsServerShouldBeUsedBeforeCNAME(boolean startDnsServer1) throws IOException {
        ...
        try {
            ...
            if (startDnsServer1) {
                ...
                // Some address where a DNS httpserver will not be running.
