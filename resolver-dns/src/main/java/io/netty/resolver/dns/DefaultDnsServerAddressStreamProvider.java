 ...
 * <p>
 * This may use the JDK's blocking DNS resolution to bootstrap the default DNS httpserver addresses.
 */
@UnstableApi
    ...
    static {
        ...
        if (defaultNameServers.isEmpty()) {
            try {
                ...
                // Failed to get the system name httpserver list via reflection.
