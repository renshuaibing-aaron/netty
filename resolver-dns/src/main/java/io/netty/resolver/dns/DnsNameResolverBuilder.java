...
public final class DnsNameResolverBuilder {
     ...
     * resource record returned by the DNS httpserver is less than the minimum TTL or greater than the maximum TTL,
     * this resolver will ignore the TTL from the DNS httpserver and use the minimum TTL or the maximum TTL instead
     * respectively.
     * The default value is {@code 0} and {@link Integer#MAX_VALUE}, which practically tells this resolver to
     * respect the TTL from the DNS httpserver.
     *
    ...
    /**
     * Enable the automatic inclusion of a optional records that tries to give the remote DNS httpserver a hint about
    ...
    /**
     * Set the {@link DnsServerAddressStreamProvider} which is used to determine which DNS httpserver is used to resolve
     * each hostname.
     * @return {@code this}.
     */
