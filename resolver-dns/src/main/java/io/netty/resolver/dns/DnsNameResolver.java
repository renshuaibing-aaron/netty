...
public class DnsNameResolver extends InetNameResolver {
     ...
     * @param authoritativeDnsServerCache the cache used to find the authoritative DNS httpserver for a domain
    ...
    /**
     * Returns the automatic inclusion of a optional records that tries to give the remote DNS httpserver a hint about how
    ...
    /**
     * Sends a DNS query with the specified question using the specified name httpserver list.
     */
    public Future<AddressedEnvelope<DnsResponse, InetSocketAddress>> query(
    ...
    /**
     * Sends a DNS query with the specified question with additional records using the specified name httpserver list.
     */
    public Future<AddressedEnvelope<DnsResponse, InetSocketAddress>> query(
