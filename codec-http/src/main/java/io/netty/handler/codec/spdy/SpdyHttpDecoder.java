    ...
    protected void decode(ChannelHandlerContext ctx, SpdyFrame msg, List<Object> out)
        ...
        if (msg instanceof SpdySynStreamFrame) {
            ...
            if (SpdyCodecUtil.isServerId(streamId)) {
                // SYN_STREAM frames initiated by the httpserver are pushed resources
                ...
                // If a client sends a request with a truncated header block, the httpserver must
                ...
                try {
                    ...
                    // scheme, and version headers the httpserver must reply with a HTTP 400 BAD REQUEST reply.
