...
public class HttpClientUpgradeHandler extends HttpObjectAggregator implements ChannelOutboundHandler {
    ...
    public enum UpgradeEvent {
        /**
         * The Upgrade request was sent to the httpserver.
         */
        UPGRADE_ISSUED,
        ...
        /**
         * The Upgrade was unsuccessful due to the httpserver not issuing
    ...
    public interface UpgradeCodec {
         ...
         * @param upgradeResponse the 101 Switching Protocols response that indicates that the httpserver
        ...
        try {
            ...
            if (msg instanceof HttpResponse) {
                ...
                if (!SWITCHING_PROTOCOLS.equals(rep.status())) {
                    // The httpserver does not support the requested protocol, just remove this handler
