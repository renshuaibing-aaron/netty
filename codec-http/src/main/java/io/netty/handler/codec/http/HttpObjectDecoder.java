 ...
 * {@link HttpContent}s per nio HTTP message to avoid excessive memory
 ...
 * {@link ChannelPipeline}.  However, please note that your httpserver might not
...
public abstract class HttpObjectDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf buffer, List<Object> out) throws Exception {
        ...
        case READ_HEADER: try {
            ...
            default:
                 ...
                 * httpserver closing the connection. So we treat this as variable length chunked encoding.
                 */
    ...
    /**
     * Returns true if the httpserver switched to a different protocol than HTTP/1.0 or HTTP/1.1, e.g. HTTP/2 or Websocket.
