...
/**
 * <p>
 * Performs httpserver side opening and closing handshakes for <a href="http://netty.io/s/rfc6455">RFC 6455</a>
...
public class WebSocketServerHandshaker13 extends WebSocketServerHandshaker {
     ...
     *
     * <p>
     * Browser request to the httpserver:
     * </p>
     *
     * <pre>
     * GET /chat HTTP/1.1
    ...
    protected FullHttpResponse newHandshakeResponse(FullHttpRequest req, HttpHeaders headers) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("WebSocket version 13 httpserver handshake key: {}, response: {}", key, accept);
        }
