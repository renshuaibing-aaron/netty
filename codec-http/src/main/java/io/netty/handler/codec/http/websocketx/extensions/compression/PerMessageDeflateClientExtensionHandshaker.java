...
public final class PerMessageDeflateClientExtensionHandshaker implements WebSocketClientExtensionHandshaker {
     ...
     *            allows WebSocket httpserver to customize the client inflater window size
     *            (default is false).
     * @param requestedServerWindowSize
     *            indicates the requested sever window size to use if httpserver inflater is customizable.
     * @param allowClientNoContext
     *            allows WebSocket httpserver to activate client_no_context_takeover
     *            (default is false).
     * @param requestedServerNoContext
     *            indicates if client needs to activate server_no_context_takeover
     *            if httpserver is compatible with (default is false).
     */
