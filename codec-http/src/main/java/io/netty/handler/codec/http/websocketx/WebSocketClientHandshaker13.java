...
public class WebSocketClientHandshaker13 extends WebSocketClientHandshaker {
     ...
     * /**
     * <p>
     * Sends the opening request to the httpserver:
     * </p>
     *
     * <pre>
     * GET /chat HTTP/1.1
     ...
     *
     * @param response
     *            HTTP response returned from the httpserver for the request sent by beginOpeningHandshake00().
