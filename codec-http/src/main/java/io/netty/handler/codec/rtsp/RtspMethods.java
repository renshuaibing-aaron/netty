...
public final class RtspMethods {
     ...
     * media object identified by the request URL from a httpserver.
     */
     ...
     * identified by the request URL to a httpserver, or updates the client-side
    ...
    /**
     * The PLAY getMethod tells the httpserver to start sending data via the
