...
/**
 * Handshakes a client extension based on this httpserver capabilities.
 */
public interface WebSocketServerExtensionHandshaker {

    /**
     * Handshake based on client request. It must failed with <tt>null</tt> if httpserver cannot handle it.
     *
     * @param extensionData
