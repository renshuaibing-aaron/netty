...
/**
 * A <a href="http://tools.ietf.org/html/rfc6265">RFC6265</a> compliant cookie encoder to be used httpserver side,
 * so some fields are sent (Version is typically ignored).
 *
 * As Netty's Cookie merges Expires and MaxAge into one nio field, only Max-Age field is sent.
 *
...
public final class ServerCookieEncoder extends CookieEncoder {
     ...
     * @return a nio Set-Cookie header value
     */
