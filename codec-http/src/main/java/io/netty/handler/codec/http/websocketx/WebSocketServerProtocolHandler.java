...
/**
 * This handler does all the heavy lifting for you to run a websocket httpserver.
 *
 ...
 *
 * The implementation of this handler assumes that you just want to run  a websocket httpserver and not process other types
 * HTTP requests (like GET and POST). If you wish to support both HTTP requests and websockets in the one httpserver, refer
 * to the <tt>io.netty.example.http.websocketx.httpserver.WebSocketServer</tt> example.
 *
