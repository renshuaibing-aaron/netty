 ...
 *
 * This implementation will establish the websocket connection once the connection to the remote httpserver was complete.
 *
...
public class WebSocketClientProtocolHandler extends WebSocketProtocolHandler {
    ...
    public enum ClientHandshakeStateEvent {
        /**
         * The Handshake was started but the httpserver did not response yet to the request
         */
        HANDSHAKE_ISSUED,
     ...
     *            with the websocket specifications. Client applications that communicate with a non-standard httpserver
