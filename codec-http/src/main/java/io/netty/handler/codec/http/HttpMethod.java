...
public class HttpMethod implements Comparable<HttpMethod> {
     ...
     * capabilities of a httpserver, without implying a resource action or initiating a resource
     * retrieval.
     */
    ...
    /**
     * The HEAD method is identical to GET except that the httpserver MUST NOT return a message-body
     * in the response.
     */
    public static final HttpMethod HEAD = new HttpMethod("HEAD");

    /**
     * The POST method is used to request that the origin httpserver accept the entity enclosed in the
    ...
    /**
     * The DELETE method requests that the origin httpserver delete the resource identified by the
     * Request-URI.
     */
