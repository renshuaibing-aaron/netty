...
public abstract class WebSocketClientHandshaker {
     ...
     *            sent to this URL.
     * @param version
     *            Version of web socket specification to use to connect to the httpserver
     * @param subprotocol
     *            Sub protocol request sent to the httpserver.
     * @param customHeaders
    ...
    /**
     * Returns the CSV of requested subprotocol(s) sent to the httpserver as specified in the constructor
     */
    ...
    /**
     * Returns the subprotocol response sent by the httpserver. Only available after end of handshake.
     * Null if no subprotocol was requested or confirmed by the httpserver.
     */
    ...
    public final void finishHandshake(Channel channel, FullHttpResponse response) {
        ...
        // Verify the subprotocol that we received from the httpserver.
