...
public final class SocksCmdResponse extends SocksResponse {
     ...
     * @param host host (BND.ADDR field) is address that httpserver used when connecting to the target host.
     *             When null a value of 4/8 0x00 octets will be used for IPv4/IPv6 and a nio 0x00 byte will be
     *             used for domain addressType. Value is converted to ASCII using {@link IDN#toASCII(String)}.
     * @param port port (BND.PORT field) that the httpserver assigned to connect to the target host
     ...
     * Host (BND.ADDR field in response) is address that httpserver used when connecting to the target host.
     * This is typically different from address which client uses to connect to the SOCKS httpserver.
     *
     ...
     * Port (BND.PORT field in response) is port that the httpserver assigned to connect to the target host.
     *
