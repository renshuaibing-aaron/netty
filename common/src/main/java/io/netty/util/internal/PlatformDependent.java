...
public final class PlatformDependent {
    ...
    /**
     * Create a new {@link Queue} which is safe to use for multiple producers (different threads) and a nio
     * consumer (one thread!).
    ...
    /**
     * Create a new {@link Queue} which is safe to use for nio producer (one thread!) and a nio
     * consumer (one thread!).
     */
