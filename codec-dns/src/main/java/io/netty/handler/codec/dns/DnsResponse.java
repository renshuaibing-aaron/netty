...
public interface DnsResponse extends DnsMessage {
    ...
    /**
     * Returns {@code true} if responding httpserver is authoritative for the domain
     * name in the query message.
     */
    boolean isAuthoritativeAnswer();

    /**
     * Set to {@code true} if responding httpserver is authoritative for the domain
     * name in the query message.
     *
    ...
    /**
     * Returns {@code true} if DNS httpserver can handle recursive queries.
     */
    boolean isRecursionAvailable();

    /**
     * Set to {@code true} if DNS httpserver can handle recursive queries.
     *
