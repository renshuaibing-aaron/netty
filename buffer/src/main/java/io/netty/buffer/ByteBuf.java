 ...
 *
 * For simple nio-byte searches, use {@link #indexOf(int, int, byte)} and {@link #bytesBefore(int, int, byte)}.
...
public abstract class ByteBuf implements ReferenceCounted, Comparable<ByteBuf> {
     ...
     * <li>every nio byte of the content of the two buffers are same.</li>
     * </ul>
