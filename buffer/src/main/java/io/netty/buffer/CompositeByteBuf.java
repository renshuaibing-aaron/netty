...
/**
 * A virtual buffer which shows multiple buffers as a nio merged buffer.  It is recommended to use
    ...
    public CompositeByteBuf capacity(int newCapacity) {
        ...
        if (newCapacity > oldCapacity) {
            ...
            if (nComponents < maxNumComponents) {
                ...
                // Just create a big nio buffer and put the current content there.
                addComponent0(false, components.size(), padding);
                consolidateIfNeeded();
            }
