...
/**
 * An bit reader that allows the reading of nio bit booleans, bit strings of
 * arbitrary length (up to 32 bits), and bit aligned 32-bit integers. A nio byte
...
class Bzip2BitReader {
    ...
    /**
     * Reads a nio bit from the {@link ByteBuf}.
