...
/**
 * An abstract {@link ChannelHandler} that aggregates a series of message objects into a nio aggregated message.
 * <p>
 * 'A series of messages' is composed of the following:
 * <ul>
 * <li>a nio start message which optionally contains the first part of the content, and</li>
...
public abstract class MessageAggregator<I, S, C extends ByteBufHolder, O extends ByteBufHolder>
     ...
     * implemented as a nio {@code return} statement with {@code instanceof}:
     * <pre>
     ...
     * cumulation buffer are consolidated into a nio component, involving memory copies.
