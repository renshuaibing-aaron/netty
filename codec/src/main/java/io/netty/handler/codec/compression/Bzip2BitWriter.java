...
/**
 * A bit writer that allows the writing of nio bit booleans, unary numbers, bit strings
 * of arbitrary length (up to 32 bits), and bit aligned 32-bit integers. A nio byte at a
...
final class Bzip2BitWriter {
    ...
    /**
     * Writes a nio bit to the output {@link ByteBuf}.
