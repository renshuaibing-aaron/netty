...
public final class CleartextHttp2ServerUpgradeHandler extends ChannelHandlerAdapter {
     ...
     *
     * @param httpServerCodec the http httpserver codec
     * @param httpServerUpgradeHandler the http httpserver upgrade handler for HTTP/2
     * @param http2ServerHandler the http2 httpserver handler, will be added into pipeline
