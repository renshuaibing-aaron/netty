...
public class DefaultHttp2Connection implements Http2Connection {
     ...
     * @param server whether or not this end-point is the httpserver-side of the HTTP/2 connection.
     */
    ...
    private final class DefaultEndpoint<F extends Http2FlowController> implements Endpoint<F> {
        ...
        DefaultEndpoint(boolean server, int maxReservedStreams) {
            ...
            // are odd and httpserver-initiated streams are even. Zero is reserved for the
