...
public class Http2Exception extends Exception {
    ...
    /**
     * Use if an error has occurred which can not be isolated to a nio stream, but instead applies
    ...
    /**
     * Use if an error which can be isolated to a nio stream has occurred.  If the {@code id} is not
    ...
    /**
     * Check if an exception is isolated to a nio stream or the entire connection.
    ...
    /**
     * Represents an exception that can be isolated to a nio stream (as opposed to the entire connection).
     */
