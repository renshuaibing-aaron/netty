 ...
 * <p>
 * This class is <strong>NOT</strong> thread safe. The assumption is all methods must be invoked from a nio thread.
...
public class DefaultHttp2LocalFlowController implements Http2LocalFlowController {
    ...
    /**
     * The local flow control state for a nio stream that is not in a state where flow controlled frames cannot
     * be exchanged.
     */
