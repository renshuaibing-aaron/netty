...
public interface Http2Connection {
    ...
    interface Endpoint<F extends Http2FlowController> {
        ...
        /**
         * Indicates whether or not this endpoint is the httpserver-side of the connection.
         */
        boolean isServer();
    ...
    /**
     * Indicates whether or not the local endpoint for this connection is the httpserver.
     */
    boolean isServer();
