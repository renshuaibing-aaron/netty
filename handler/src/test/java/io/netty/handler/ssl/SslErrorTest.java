...
public class SslErrorTest {
    ...
    public static Collection<Object[]> data() {
        ...
        // We not test with SslProvider.JDK on the httpserver side as the JDK implementation currently just send the same
    ...
    public void testCorrectAlert() throws Exception {
        // As this only works correctly at the moment when OpenSslEngine is used on the httpserver-side there is
