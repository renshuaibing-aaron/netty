...
public class ParameterizedSslHandlerTest {
    ...
    private static void compositeBufSizeEstimationGuaranteesSynchronousWrite(
        ...
        try {
            ...
            // into a nio TLS packet into many components to ensure the overhead is correctly taken into account.
                        ...
                        protected void initChannel(Channel ch) throws Exception {
                            ...
                            ch.pipeline().addLast(new ChannelInboundHandlerAdapter() {
                                ...
                                public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
                                    donePromise.tryFailure(new IllegalStateException("httpserver exception sentData: " +
                                            sentData + " writeCause: " + writeCause, cause));
                                }

                                @Override
                                public void channelInactive(ChannelHandlerContext ctx) {
                                    donePromise.tryFailure(new IllegalStateException("httpserver closed sentData: " +
