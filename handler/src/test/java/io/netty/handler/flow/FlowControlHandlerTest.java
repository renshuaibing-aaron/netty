...
public class FlowControlHandlerTest {
        ...
        bootstrap.group(GROUP)
            ...
            .handler(new ChannelInboundHandlerAdapter() {
                ...
                public void channelRead(ChannelHandlerContext ctx, Object msg) {
                    fail("In this test the client is never receiving a message from the httpserver.");
                }
            });
    ...
    public void testAutoReadingOff() throws Exception {
        ...
        try {
            // The client connection on the httpserver side
