...
/**
 * {@link OpenSslSessionContext} implementation which offers extra methods which are only useful for the httpserver-side.
 */
public final class OpenSslServerSessionContext extends OpenSslSessionContext {
    ...
    /**
     * Set the context within which session be reused (httpserver side only)
