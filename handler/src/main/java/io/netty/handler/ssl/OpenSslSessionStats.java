...
public final class OpenSslSessionStats {
    ...
    /**
     * Returns the number of started SSL/TLS handshakes in httpserver mode.
     */
    public long accept() {
        Lock readerLock = context.ctxLock.readLock();
        readerLock.lock();
    ...
    /**
     * Returns the number of successfully established SSL/TLS sessions in httpserver mode.
     */
    ...
    /**
     * Returns the number of start renegotiations in httpserver mode.
     */
     ...
     * successfully reused is counted as a hit. In httpserver mode, a session successfully retrieved from internal or
    ...
    /**
     * Returns the number of successfully retrieved sessions from the external session cache in httpserver mode.
     */
    public long cbHits() {
        Lock readerLock = context.ctxLock.readLock();
        readerLock.lock();
     ...
     * in httpserver mode, but that were invalid due to timeout. These sessions are not included in the {@link #hits()}
     * count.
     */
