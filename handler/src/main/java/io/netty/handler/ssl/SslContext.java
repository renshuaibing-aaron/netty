 ...
 *
 * <h3>Making your httpserver support SSL/TLS</h3>
 * <pre>
...
public abstract class SslContext {
    ...
    /**
     * Returns the default httpserver-side implementation provider currently in use.
     *
    ...
    /**
     * Creates a new httpserver-side {@link SslContext}.
     *
     * @param certChainFile an X.509 certificate chain file in PEM format
     * @param keyFile a PKCS#8 private key file in PEM format
     * @return a new httpserver-side {@link SslContext}
    ...
    public static SslContext newServerContext(
        ...
        try {
            ...
            throw new SSLException("failed to initialize the httpserver-side SSL context", e);
        }
    }
    ...
    /**
     * Returns {@code true} if and only if this context is for httpserver-side.
     */
     ...
     * limits wrap/unwrap to operate on a nio SSL/TLS packet.
