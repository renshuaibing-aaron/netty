 ...
 * (Server Name Indication)</a> extension for httpserver side SSL. For clients
 * support SNI, the httpserver could have multiple host name bound on a nio IP.
 * The client will send host name in the handshake data so httpserver could decide
