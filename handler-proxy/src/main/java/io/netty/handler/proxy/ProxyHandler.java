...
public abstract class ProxyHandler extends ChannelDuplexHandler {
    ...
    /**
     * Returns the address of the proxy httpserver.
     */
    ...
    /**
     * Returns the address of the destination to connect to via the proxy httpserver.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Adds the codec handlers required to communicate with the proxy httpserver.
     */
    ...
    /**
     * Sends the initial message to be sent to the proxy httpserver. This method also starts a timeout task which marks
    ...
    /**
     * Returns a new message that is sent at first time when the connection to the proxy httpserver has been established.
     *
     * @return the initial message, or {@code null} if the proxy httpserver is expected to send the first message instead
     */
    protected abstract Object newInitialMessage(ChannelHandlerContext ctx) throws Exception;

    /**
     * Sends the specified message to the proxy httpserver.  Use this method to send a response to the proxy httpserver in
    ...
    /**
     * Handles the message received from the proxy httpserver.
     *
     ...
     *         expected from the proxy httpserver
     */
