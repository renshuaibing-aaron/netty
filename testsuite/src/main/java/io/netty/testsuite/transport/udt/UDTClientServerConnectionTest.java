...
public class UDTClientServerConnectionTest {
    ...
    static class Server implements Runnable {
        ...
        final ChannelGroup group = new DefaultChannelGroup("httpserver group", GlobalEventExecutor.INSTANCE);
        ...
        public void run() {
            ...
            final ThreadFactory serverFactory = new DefaultThreadFactory("httpserver");
    ...
    /**
     * Verify UDT client/httpserver connect and disconnect.
     */
    @Test
    public void connection() throws Exception {
        ...
        final Thread serverTread = new Thread(server, "httpserver-*");
        serverTread.start();
